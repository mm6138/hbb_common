...
lazy_static::lazy_static! {
    ...
    pub static ref PROD_RENDEZVOUS_SERVER: RwLock<String> = RwLock::new("46.8.78.62".to_owned());
...
pub const RS_PUB_KEY: &str = "1+awZtYDhEeeXMpYChWa0LEnyeZNAt0uToyLOX2f6v4=";
